...
bool bpm(int u, bool seen[], int matchR[]) {
    ...
    for(int v = 0; v < N; v++) {
        // Nếu có yêu thích và chưa được duyệt qua
...
int maxBPM() {
    ...
    // Ban đầu chưa có ai làm
    memset(matchR, -1, sizeof(matchR));
 
    // Kết quả
    int result = 0;
    for (int u = 0; u < M; u++) {
        // Gán tất cả các công việc là chưa được xét
        bool seen[N];
